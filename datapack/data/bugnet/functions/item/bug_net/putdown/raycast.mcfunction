...
execute if entity @s[tag=!bugnet.tag] unless block ^ ^ ^0.01 #bugnet:raycast_ignore positioned ^ ^ ^0.01 run function bugnet:item/bug_net/putdown/summon_entity with storage bugnet:storage root.temp.item.tag.bugnet
